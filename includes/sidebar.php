...
<aside class="sidebar" id="mainSidebar">
    ...
    <nav class="nav-menu">
        ...
        <a href="<?php echo $base_path ?? ''; ?>product/cart.php" class="nav-item <?php echo $current_page == 'cart.php' ? 'active' : ''; ?>">
            <div style="position: relative; display: flex; align-items: center; width: 100%; gap: 0.75rem;">
                ...
                <span>My Cart</span>
                <?php if ($cart_count > 0): ?>
                    <span style="margin-left: auto; background: var(--primary); color: white; font-size: 0.7rem; padding: 2px 6px; border-radius: 6px; font-weight: 700;"><?php echo $cart_count; ?></span>
                <?php endif; ?>
            </div>
        </a>
        <?php endif; ?>
        ...
        <?php if ($user_role === 'admin'): ?>
        <a href="<?php echo $base_path ?? ''; ?>reports.php" class="nav-item <?php echo $current_page == 'reports.php' ? 'active' : ''; ?>">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <nav class="nav-menu">
        <a href="<?php echo $base_path ?? ''; ?>settings.php" class="nav-item <?php echo $current_page == 'settings.php' ? 'active' : ''; ?>">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
